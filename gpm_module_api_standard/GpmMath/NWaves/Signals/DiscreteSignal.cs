...
namespace NWaves.Signals
{
    ...
    public class DiscreteSignal
    {
        ...
        public double[] doubleSamples { get; set; }
        ...
        public double Duration
        {
            get
            {
                return (double)Samples.Length / SamplingRate;
            }
        }
        ...
        /// </summary>
        /// <returns>Energy</returns>
        public float Energy() { return Energy(0, Length); }
        ...
        /// </summary>
        /// <returns>RMS</returns>
        public float Rms() { return (float)Math.Sqrt(Energy(0, Length)); }
        ...
        /// </summary>
        /// <returns>Zero-crossing rate</returns>
        public float ZeroCrossingRate() { return ZeroCrossingRate(0, Length); }
