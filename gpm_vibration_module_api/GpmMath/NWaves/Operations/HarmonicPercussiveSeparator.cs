...
namespace NWaves.Operations
{
    ...
    public class HarmonicPercussiveSeparator
    {
        ...
        {
            Tuple<MagnitudePhaseList, MagnitudePhaseList> tuples = EvaluateSpectrograms(signal);
            var harmonicSpectrogram = tuples.Item1;
            var percussiveSpectrogram = tuples.Item2;
